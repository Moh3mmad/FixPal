...
public static class DemoPaymentCalculator
{
    ...
    {
        if (quote?.AcceptedAtUtc == null || quote.AcceptedRevision == null || quote.State != QuoteState.Accepted) return null;
        var deposit = Round(quote.AcceptedRevision.MinimumPrice * IllustrativeDepositRate);
